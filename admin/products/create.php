                            ...
                            <div class="card-body card-block">
                                <form method="post" class="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nf-email" name="product_name" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-email" class=" form-control-label">Price</label>
                                        <input type="text" id="nf-email" name="product_price" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-password" class=" form-control-label">Description</label>
                                        <input type="text" id="nf-password" name="product_desc" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="nf-password" name="sales_percentage" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-password" class=" form-control-label">Stock</label>
                                        <input type="number" id="nf-password" name="stock" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nf-password" class=" form-control-label">Image</label>
                                        <input type="text" id="nf-password" name="product_img" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <!-- <input type="number" id="nf-password" name="cat_id" class="form-control" required> -->
                                    </div>
                                ...
                                if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['add']) {
                                    ...
                                    $sql = "INSERT INTO products (product_name,product_price,product_desc,on_sales,sales_percentage,stock,product_img,cat_id)
                                    VALUES ('$product_name','$product_price',
                                    '$product_desc','$on_sales','$sales_percentage','$stock','$product_img','$cat_id')";
