                    ...
                    <div class="product_sidebar">
                        ...
                        <div class="single_sedebar">
                            <div class="select_option">
                                <div  class="select_option_list" style='margin: auto; border-radius: 13px !important;   color:#5d445a;'>Category  </div><br>
                                <div class="select_option_list"  style="border-radius: 13px !important;">
                                    <?php
