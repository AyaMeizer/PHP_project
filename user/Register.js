...
const smallPhone = document.querySelector("#phoneMessage");
...
phone.addEventListener("keyup", phoneTracker);
function phoneTracker() {
  let phoneValue = phone.value;
  if (phoneValue !== phone.value) {
    smallPhone.style.visibility = "visible";
    smallPhone.innerHTML = "Your number is incorrect";
    smallPhone.style.color = "red";
  } else {
    smallPhone.style.visibility = "hidden";
    phoneState = true;
  }
}
...
submit.addEventListener("click", (e) => {
  ...
  if (!phoneState) {
    e.preventDefault();
    smallPhone.style.visibility = "visible";
    smallPhone.innerHTML = "Cannot be empty";
    smallPhone.style.color = "red";
  }
});